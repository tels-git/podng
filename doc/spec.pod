...
If you use a normal C<POD> parser on this document, a few errors will appear,
...
P<ProductName> P<< Some Cool Product™ >>
...
S<With  fixed  spacing> S<< more   fixed   width   spacing >>
...
Email with alternative text: L<My email|mailto:nouser@example.com> L<< email|mailto:none@example.com >>
...
=begin sourcecode [perlcode] ::perl A simple program
